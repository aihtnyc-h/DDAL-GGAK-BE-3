...
sudo nohup java -jar /home/ubuntu/app/deploy/DDAL-GGAK-BE-0.0.1-SNAPSHOT.jar --spring.config.location=file:/home/ubuntu/app/config/prod-application.yaml --spring.profiles.active=$IDLE_PROFILE --server.port=$IDLE_PORT > /home/ubuntu/app/logs/app.log 2>&1 &
